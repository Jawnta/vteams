...
require("../css/Scooters.css");
const ScootersTable_1 = require("./ScootersTable");
const Scooters = () => {
    ...
    (0, react_1.useEffect)(() => {
        ...
        const getCities = () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield fetch(`/cities/`);
            return yield response.json();
        });
        getScooters().then(r => setScooters(r));
        getCities().then(r => setCities(r));
    }, []);
    return (<div className="scooter-wrapper">
            <div className="scooters">
                <ScootersTable_1.ScootersTable scooters={scooters} cities={cities}/>
