...
router.put('/:invoiceId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const invoice = req.body;
    if (!invoice.trip_id || !invoice.status || !invoice.amount) {
        res.sendStatus(400);
    }
    try {
        const result = yield invoices_1.invoices.putInvoiceId(invoice);
...
router.delete('/:invoiceId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const invoiceId = +req.params.invoiceId;
    try {
