...
router.get('/', (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
        try {
            const result =
                yield chargingzones_1.chargingZones.getChargingZones();
...
router.post('/', (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const result =
                yield chargingzones_1.chargingZones.postChargingZones(data);
            res.status(result.status || 200).send(result.data);
        } catch (err) {
            return res.status(500).send({
                error: err || 'Something went wrong.',
...
router.get('/:chargingZoneId', (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const result =
                yield chargingzones_1.chargingZones.getChargingZoneId(
                    chargingZoneId
                );
            res.status(result.status || 200).send(result.data);
        } catch (err) {
...
router.put('/:chargingZoneId', (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const result =
                yield chargingzones_1.chargingZones.putChargingZoneId(data);
            res.status(result.status || 200).send(result.data);
        } catch (err) {
            return res.status(500).send({
                error: err || 'Something went wrong.',
...
router.delete('/:chargingZoneId', (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const result =
                yield chargingzones_1.chargingZones.deleteChargingZoneId(
                    chargingZoneId
                );
            res.status(result.status || 200).send(result.data);
        } catch (err) {
