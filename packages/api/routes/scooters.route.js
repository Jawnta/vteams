...
router.delete('/:scooterId', (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
        const scooterId = +req.params.scooterId;
        try {
...
router.get('/:scooterId/logs', (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
        const scooterId = +req.params.scooterId;
        try {
            const result = yield scooters_1.scooters.getScooterIdLogs(
                scooterId
            );
            res.status(result.status || 200).send(result.data);
        } catch (err) {
