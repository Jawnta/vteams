...
router.get('/:invoiceId', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
router.put('/:invoiceId', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
router.delete('/:invoiceId', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const invoiceId = +req.params.invoiceId;
    try {
